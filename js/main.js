document.addEventListener('DOMContentLoaded', function() {
      ...
      try {
        ...
        reports.forEach(report => {
          ...
          row.innerHTML = `
            ...
            <td>${createdDate}</td>
            <td>
              <button class="btn btn-sm btn-primary action-btn view-report" data-id="${report.id}">
    ...
    async function loadReportDetails(reportId) {
      try {
        ...
        // Store report ID for actions
        generateDataBtn.setAttribute('data-id', reportId);
        emailReportBtn.setAttribute('data-id', reportId);
        downloadCsvBtn.setAttribute('data-id', reportId);
        
        // Check if report data exists
        checkReportData(reportId);
